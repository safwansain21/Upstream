...
type Report = { id: string; case_id: string; case_title: string; workflow: string; description: string; categories: string[]; observed_at: string; timezone: string; landmark: string; location_precision: string; latitude: number | null; longitude: number | null; public_visibility: boolean; version: number; data_origin: string; created_at: string; versions: { version: number; created_at: string; change_reason: string | null }[] };
